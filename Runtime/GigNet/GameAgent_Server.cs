...
public interface GameAgent_Server
{
    ...
    public void CreateRoom(long ID, int capacity, int bots, bool botWins, int[] botIndices);
    public void OnFilledRoom(long id, Room room);
    public void OnPlayerDisconnect(long RoomID, int IDInRoom);
    
    public void PlayerLost(long RoomID, int IDInRoom);
    public void PlayerRestored(long RoomID, int IDInRoom);
